hi clear
syntax reset
let g:colors_name = "material-neutral"
if &background == "light"
...
elseif &background == "dark"
    hi Boolean gui=NONE guifg=#f27d6e guibg=NONE
    hi ColorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi Comment gui=NONE guifg=#556c77 guibg=NONE
    hi Conceal gui=NONE guifg=#808080 guibg=NONE
    hi Conditional gui=NONE guifg=#bd8ddd guibg=NONE
    hi Constant gui=NONE guifg=#808080 guibg=NONE
    hi Cursor gui=reverse guifg=#f2c40d guibg=#1f282e
    hi CursorColumn gui=NONE guifg=NONE guibg=#1a1a1a
    hi CursorLine gui=NONE guifg=NONE guibg=#1f282e
    ...
    hi Directory gui=NONE guifg=#ced4de guibg=NONE
    ...
    hi Normal gui=NONE guifg=#b4cbd5 guibg=#253137
    hi Number gui=NONE guifg=#f27d6e guibg=NONE
    ...
    hi Special gui=NONE guifg=#8bd8f9 guibg=NONE
    ...
    hi Statement gui=NONE guifg=#f65a74 guibg=NONE
    hi StatusLine gui=NONE guifg=#556c77 guibg=#1f282e
    hi StatusLineNC gui=NONE guifg=#f0fefe guibg=#262626
    hi StorageClass gui=NONE guifg=#f7c869 guibg=NONE
    hi String gui=NONE guifg=#c3e58f guibg=NONE
    hi TabLine gui=NONE guifg=#556c77 guibg=#1f282e
    hi TabLineFill gui=NONE guifg=NONE guibg=#1f282e
    hi TabLineSel gui=NONE guifg=#ced4de guibg=#1f282e
    hi Title gui=NONE guifg=#ced4de guibg=NONE
    hi Todo gui=standout guifg=NONE guibg=NONE
    hi Type gui=NONE guifg=#f7c869 guibg=NONE
    hi Underlined gui=NONE guifg=NONE guibg=NONE
    ...
    hi WildMenu gui=NONE guifg=NONE guibg=#1f282e
    hi lCursor gui=NONE guifg=NONE guibg=NONE
    hi Identifier gui=NONE guifg=NONE guibg=NONE
    hi PreProc gui=NONE guifg=NONE guibg=NONE
endif